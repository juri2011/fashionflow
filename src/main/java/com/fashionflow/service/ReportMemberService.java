...
public class ReportMemberService {
    ...
    public Long addReportMember(ReportMemberDTO reportMemberDTO){
        ...
        //신고한 회원 정보
        Member reporterMemeber = memberRepository.findByEmail(reportMemberDTO.getReporterMemberEmail());
        if(reporterMemeber == null){
        ...
        reportMember.setReporterMember(reporterMemeber);
